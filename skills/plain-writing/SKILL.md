---
name: plain-writing
description: Write and edit in plain American English — active voice, front-loaded content, sentence case, and no bold or italics for emphasis. Use when writing or editing reports, research write-ups, guidance, documentation, summaries, or any prose where clarity and accessibility matter.
user-invokable: true
args:
  - name: target
    description: The document or text to write or rewrite in plain style (optional)
    required: false
---

Open the content up so anyone can understand it the first time they read it — without losing any of the substance, nuance, or precision. The goal is to open up, not to dumb down.
...
- Start from the reader's need. Write what the reader needs to know to do or decide something, not what you want to say.
...
- Address the reader as "you." Write about yourself or the organization as "we." Use "they," "them," and "their" rather than gendered pronouns.
...
- Do not use bold or italics for emphasis. Plain words and good structure carry the meaning. Bold is only acceptable to name a literal interface element in an instruction, for example: select Save. Use double quotation marks for the titles of schemes or documents.
...
- Do not use Latin abbreviations. Write "for example" not "e.g.," "that is" not "i.e.," "and so on" or "such as" not "etc." They slow readers down.
- Ampersands: write "and," not "&" (except in a registered name or logo).
- Numbers: write "one" but use numerals from 2 upward (2, 9, 25). Use the % symbol with numerals (50%). Use $ with no decimals unless there are cents ($75, $75.50). Spell out millions and billions ($5 million, not $5M). Write ranges with "to," not a hyphen (10 to 20, Monday to Friday).
- Dates and times: write "June 4, 2026." Use "to" for ranges ("June 4 to 8"). Write times as "10 am to 11:30 am"; use "noon" and "midnight."
- Do not use FAQs. If you have answered the reader's need in the content, you do not need them. Do not use exclamation marks. Do not use ALL CAPS for emphasis.
